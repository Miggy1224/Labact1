...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{ config('app.url') . 'storage/' . (isset($settings["icon"]) ? $settings["icon"] : 'default-icon.png')}} " type="image/x-icon" />
...
<body class="clinic_version">
    ...
    src="{{ config('app.url') . 'storage/' . (isset($settings["logo"]) ? $settings["logo"] : 'default-logo.png') }}"
    alt="logo image "></a>
...
<span class="iconcont"><a
    href="tel:{{ isset($settings["phone"]) ? $settings["phone"] : '123 123 123' }}">{{ isset($settings["phone"]) ? $settings["phone"] : '123 123 123' }}</a></span>
                        </div>
                        <div class="info-inner">
                        <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
<span class="iconcont"><a data-scroll
    href="mailto:{{ isset($settings["email"]) ? $settings["email"] : 'miguelcalimlim123@gmail.com' }}">{{ isset($settings["email"]) ? $settings["email"] : 'miguelcalimlim123@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                        <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
<span class="iconcont"><a data-scroll href="#">Daily:
    {{ isset($settings["working_horse"]) ? $settings["working_horse"] : '7:00 AM - 8:00 PM' }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img src="{{ 'storage/'.(isset($settings["logo"]) ? $settings["logo"] : 'default-logo.png') }}"
                    alt="">
                    <p>{{ isset($settings["description"]) ? $settings["description"] : 'hi this isLocavore pork belly scen ester pine est chill wave microdosing pop uple itarian cliche artisan.' }}
                    </p>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    aria-hidden="true"></i>{{ isset($settings["address"]) ? $settings["address"] : 'distric abc P/O xyz sorana' }}
</p>
<p><i class="fa fa-paper-plane"
    aria-hidden="true"></i>{{ isset($settings["email"]) ? $settings["email"] : 'miguelcalimlim123@gmail.com' }}
</p>
<p><i class="fa fa-phone"
aria-hidden="true"></i>{{ isset($settings["phone"]) ? $settings["phone"] : '09177701081' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
